...
Partial Public Class DSetPembayaran
    ...
    Partial Public Class DataTable1DataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddDataTable1Row(ByVal NoNotaJual As String, ByVal TglNota As Date, ByVal GrandTotal As Integer, ByVal TglBayar As Date, ByVal UangBayar As Integer) As DataTable1Row
            Dim rowDataTable1Row As DataTable1Row = CType(Me.NewRow,DataTable1Row)
            Dim columnValuesArray() As Object = New Object() {NoNotaJual, Nothing, TglNota, GrandTotal, TglBayar, UangBayar}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function FindByNoNotaJualNoNotaPembayaran(ByVal NoNotaJual As String, ByVal NoNotaPembayaran As Integer) As DataTable1Row
            Return CType(Me.Rows.Find(New Object() {NoNotaJual, NoNotaPembayaran}),DataTable1Row)
        End Function
    ...
    Partial Public Class DataTable1Row
        ...
        Public Property NoNotaJual() As String
            Get
                Return CType(Me(Me.tableDataTable1.NoNotaJualColumn),String)
            End Get
            Set
                Me(Me.tableDataTable1.NoNotaJualColumn) = value
            End Set
        End Property
        ...
        Public Property NoNotaPembayaran() As Integer
            Get
                Return CType(Me(Me.tableDataTable1.NoNotaPembayaranColumn),Integer)
            End Get
            Set
                Me(Me.tableDataTable1.NoNotaPembayaranColumn) = value
            End Set
        End Property
        ...
        Public Property TglNota() As Date
            Get
                Return CType(Me(Me.tableDataTable1.TglNotaColumn),Date)
            End Get
            Set
                Me(Me.tableDataTable1.TglNotaColumn) = value
            End Set
        End Property
        ...
        Public Property GrandTotal() As Integer
            Get
                Return CType(Me(Me.tableDataTable1.GrandTotalColumn),Integer)
            End Get
            Set
        ...
        Public Property UangBayar() As Integer
            Get
                Return CType(Me(Me.tableDataTable1.UangBayarColumn),Integer)
            End Get
            Set
                Me(Me.tableDataTable1.UangBayarColumn) = value
            End Set
        End Property
    End Class
...
Namespace DSetPembayaranTableAdapters
    ...
    Partial Public Class DataTable1TableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT H.NoNotaJual, T.NoNotaPembayaran, H.TglNota, H.GrandTotal, T.TglBayar, T.U"& _ 
                "angBayar from HJual H, TbPembayaran T WHERE H.NoNotaJual = T.NoNotaJual"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As DSetPembayaran.DataTable1DataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As DSetPembayaran.DataTable1DataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DSetPembayaran.DataTable1DataTable = New DSetPembayaran.DataTable1DataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
    End Class
